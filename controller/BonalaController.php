<?php
namespace BonalaPHP\Controller;
use BonalaPHP\Model\Authentication;
use BonalaPHP\Model\Post;

/**
 * Class BonalaController
 * @package BonalaPHP\Controller
 */
class BonalaController {
    ...
    /**
     * BonalaController constructor.
     */
    public function __construct() {
        $this->manager = new \BonalaPHP\app\BonalaManager;
	...
	public function home() {
	 ...
	 /**
     * Generation of the about page.
     */
	public function about() {
		$this->manager->post = $this->modelPost->getAll();
        $this->manager->getView('about');
	
	}
	
	 /**
     * Generation of the services page.
     */
	public function services() {
		$this->manager->post = $this->modelPost->getAll();
        $this->manager->getView('services');
	
	}
		 /**
     * Generation of the pricing page.
     */
	public function pricing() {
		$this->manager->post = $this->modelPost->getAll();
        $this->manager->getView('pricing');
	
	}
	
			 /**
     * Generation of the terms page.
     */
	public function terms() {
		$this->manager->post = $this->modelPost->getAll();
        $this->manager->getView('terms');
	
	}
	
	
    /**
     * Generation of the  case study page.
     */
	public function case_study() {
		$this->manager->post = $this->modelPost->getAll();
        $this->manager->getView('case_study');
    ...
    public function login() {
        if (!empty($_SESSION)) {
            ...
            if($this->modelAuthentication->getAuthentication($_POST['username'], $_POST['password'])) {
                ...
                $this->manager->msgError = 'Your login details are not correct. Please try again.';
            }
        }
